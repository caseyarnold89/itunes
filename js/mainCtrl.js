...
app.controller('mainCtrl', function($scope, itunesService){
  ...
  $scope.getSongData = function(artist) {
      var promise = itunesService.findArtist(artist);
  ...
  //If everything worked you should see a huge array of objects inside your console. That's great! But unfortunately that's not what ng-grid 
  //is expecting. What you need to do now
  ...
  */
  ...
  //Once you have that final data array, you simply need to put it on the scope (or more specifically on the scope as songData). Once you do 
  //this ($scope.songData = myFinalArray) then ng-grid will see that and populate the page.
